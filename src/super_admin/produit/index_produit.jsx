          ...
          {list_produit.length !== 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {list_produit.map((i) => (
                <div
                  key={i.id_produit}
                  className="border-4 border-double border-blue-500 bg-blue-200 p-4 rounded-lg shadow-lg flex flex-col items-center"
                >
                  <div className="info text-center mb-4">
                    <p className="text-xl font-semibold">{i.nom}</p>
                    <p className="text-gray-700">Prix: {i.prix_produit}€</p>
                  ...
                  <img
                    ...
                    src={`http://localhost:8000/image/${i.image}`}
                    alt={i.image}
                  />
